  ...
  return (
    <div className="homepage">
      ...
      <div className="container">
        <div className="cards">
          <img className="chiziq" src="./public/imgs/Group 11.png" alt="" />
          <div className="box">
            <img src="./public/imgs/Group 8.svg" alt="" />
          ...
          <div className="box">
            <img src="./public/imgs/Group 9.svg" alt="" />
          ...
          <div className="box">
            <img src="./public/imgs/Group 10.svg" alt="" />
        ...
        <section className="sec_1">
          ...
          <img src="./public/imgs/Group 15.png" alt="" />
        </section>
        <section className="sec_2">
          <img src="./public/imgs/Group 14.png" alt="" />
        ...
        <section className="sec_1">
          ...
          <img src="./public/imgs/Group 18.png" alt="" />
        </section>
      </div>
    </div>
  );
